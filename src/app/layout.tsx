...
export const metadata: Metadata = {
  ...
  description:
    "SRV Detailing — mobile car valeting and detailing across Manchester, Warrington, Macclesfield, Congleton and Wilmslow. Paint correction, ceramic coating, interior deep cleaning. 22+ years experience. We come to you.",
  ...
  "@graph": [
    {
      ...
      "slogan": "Professional Mobile Car Detailing & Valeting — We Come to You",
      "foundingDate": "2003",
      "knowsAbout": [
        "Car Detailing",
        "Mobile Car Valeting",
