...
export const metadata: Metadata = {
  title: 'Areas We Serve in Manchester | SRV Detailing',
  description:
    'SRV Detailing provides mobile car detailing and valeting across all of Greater Manchester. Find your local area for services, postcodes and booking information.',
  keywords: ['car detailing manchester areas', 'mobile valeting manchester', 'car care greater manchester'],
  alternates: { canonical: 'https://www.srvdetailing.co.uk/manchester/areas' },
};
      ...
      <section className="pt-32 pb-16 bg-gradient-to-b from-primary/5 to-white px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
            Areas We Serve Across <span className="text-primary">Greater Manchester</span>
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Based in Stockport, we provide mobile car detailing and valeting across every borough of Greater Manchester. Select your area below.
          </p>
        </div>
      </section>
