import { Shield, Sparkles, Paintbrush, Car, Wrench, CircleDot, Armchair, Lightbulb, Tag } from 'lucide-react';
...
export const warringtonCarDetailingPillar: PillarPageData = {
  ...
  services: [
    ...
    },
    {
      ...
      icon: Car,
      href: '/warrington/car-detailing/new-car-protection',
    },
    {
      ...
      icon: Lightbulb,
      href: '/warrington/car-detailing/headlight-restoration',
    },
    {
      slug: 'engine-bay-detailing',
      name: 'Engine Bay Detailing',
      description:
        'Safe degreasing and dressing of engine bays — essential for Warrington vehicles exposed to heavy industrial and motorway grime.',
      icon: Wrench,
      href: '/warrington/car-detailing/engine-bay-detailing',
    },
    {
      slug: 'leather-conditioning',
      name: 'Leather Conditioning',
      description:
        'pH-balanced cleaning, nourishing conditioning and UV protection for leather interiors. Preserves quality through Cheshire winter heating cycles.',
      icon: Armchair,
      href: '/warrington/car-detailing/leather-conditioning',
    },
    {
      slug: 'swirl-mark-removal',
      name: 'Swirl Mark Removal',
      description:
        'Machine polishing removes circular wash scratches caused by automated car washes and incorrect technique. Restores deep, clear reflectivity.',
      icon: Sparkles,
      href: '/warrington/car-detailing/swirl-mark-removal',
    },
    {
      slug: 'prices',
      name: 'Detailing Prices',
      description:
        'Transparent pricing for all car detailing services in Warrington. Ceramic coating from £300, paint correction from £250. No call-out fees for WA1–WA4.',
      icon: Tag,
      href: '/warrington/car-detailing/prices',
    },
  ],
  contentSections: [
    {
