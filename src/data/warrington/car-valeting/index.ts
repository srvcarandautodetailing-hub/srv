import { Star, Droplets, CheckCircle, Car, MapPin, Wind, Scissors, Armchair, Tag } from 'lucide-react';
...
export const warringtonCarValetingPillar: PillarPageData = {
  ...
  services: [
    ...
    },
    {
      ...
      icon: CheckCircle,
      href: '/warrington/car-valeting/interior-valeting',
    },
    {
      ...
      icon: Car,
      href: '/warrington/car-valeting/exterior-valeting',
    },
    {
      slug: 'odour-removal',
      name: 'Odour Removal',
      description:
        'Deep cleaning and ozone treatment permanently eliminates smoke, pet, damp and food smells from vehicle interiors.',
      icon: Wind,
      href: '/warrington/car-valeting/odour-removal',
    },
    {
      slug: 'pet-hair-removal',
      name: 'Pet Hair Removal',
      description:
        'Specialist extraction of embedded dog and cat hair from fabric seats, carpets and boot liners across WA postcodes.',
      icon: Scissors,
      href: '/warrington/car-valeting/pet-hair-removal',
    },
    {
      slug: 'upholstery-cleaning',
      name: 'Upholstery Cleaning',
      description:
        'Hot water extraction removes embedded stains from fabric seats, carpets and boot liners. Professional results at your Warrington door.',
      icon: Armchair,
      href: '/warrington/car-valeting/upholstery-cleaning',
    },
    {
      slug: 'prices',
      name: 'Valeting Prices',
      description:
        'Transparent pricing for all car valeting services in Warrington. Maintenance valet from £45, full valet from £90. No call-out fees for WA1–WA4.',
      icon: Tag,
      href: '/warrington/car-valeting/prices',
    },
  ],
  contentSections: [
    {
