...
export const LOCATIONS_NAV: LocationNavItem[] = [
  ...
  },
  {
    ...
    subLinks: [
      ...
      { label: 'Areas in Macclesfield', href: '/macclesfield/areas' },
    ],
  },
  {
    name: 'Congleton',
    href: '/congleton',
    subLinks: [
      { label: 'Car Detailing Congleton', href: '/congleton/car-detailing' },
      { label: 'Car Valeting Congleton', href: '/congleton/car-valeting' },
      { label: 'Areas near Congleton', href: '/congleton/areas' },
    ],
  },
];
...
export const FOOTER_LINKS = {
  ...
  areas: [
    ...
    { label: 'Macclesfield Areas', href: '/macclesfield/areas' },
    { label: 'Congleton Areas', href: '/congleton/areas' },
    ...
    { label: 'Prestbury', href: '/macclesfield/areas/prestbury' },
    { label: 'Bollington', href: '/macclesfield/areas/bollington' },
  ],
  company: [
